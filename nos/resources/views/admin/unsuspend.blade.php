...
Desc: HTML page for NOS User Unsuspend.
->
...
<div class="container-fluid">
  <div class="row">
	...
	<!-- FUNCTION -->
	<h3><span class="label label-info">Unsuspend a User</span></h3>
	<hr>
	...
	<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/unsuspend') }}">
