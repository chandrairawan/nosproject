...
@section('content')
<title>Give Admin Privilege</title>
<div class="container-fluid">
  <div class="row">
	...
	<!-- FUNCTION -->
	<h3><span class="label label-info">Give Admin Privilege</span></h3>
	<hr>
	...
	<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/privilege') }}">
